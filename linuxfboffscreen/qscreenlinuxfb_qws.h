...
class QLinuxFbScreenOfsPrivate;

class Q_GUI_EXPORT QLinuxFbScreenOfs : public QScreen
{
public:
    explicit QLinuxFbScreenOfs(int display_id);
    virtual ~QLinuxFbScreenOfs();
...
private:
    ...
    QLinuxFbScreenOfsPrivate *d_ptr;
};
